          ...
          <Container>
              ...
              <NavLink to="/" className="text-decoration-none">
                <div className="d-flex justify-center align-items-center text-white">
                  <img
                    ...
                    alt="Online Shopping"
                  />
                  <h4 className="mx-2">Online Shopping</h4>
                </div>
              </NavLink>
            </Navbar.Brand>
            <Navbar.Toggle
            ...
            <Navbar.Collapse id="basic-navbar-nav">
              <Nav className="m-auto align-items-center">
                <NavLink
                  to="/"
                  className="text-decoration-none text-white text-center fw-bold mx-3 mb-2"
                >
                  HOME
                </NavLink>
                <NavLink
              ...
              <div className="text-center">
                ...
                {isLoggedIn && (
                  <button
                    ...
                    className="btn text-decoration-none text-white text-center fw-bold mx-3 mb-2"
                  >
                    LOGOUT
                  </button>
                )}
